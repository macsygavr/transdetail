    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        `
          ...
          w-auto h-[34px] md:h-[40px] px-[10px] py-[10px]

          text-[12px] leading-[14px] md:text-[14px] md:leading-[16px] whitespace-nowrap

          bg-transparent outline-none rounded-[6px]
          border
          ...
          *:data-[slot=select-value]:gap-2
          data-[placeholder]:text-neutral-gray

          [&_svg]:shrink-0
          [&_svg:not([class*='size-'])]:size-4
          [&_svg:not([class*='text-'])]:text-main-red
